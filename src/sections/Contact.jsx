...
const contactInfo = [
  {
    icon: Mail,
    label: "Email",
    value: "jatin.deu5@gmail.com",
    href: "mailto:jatin.deu5@gmail.com",
  },
  {
    icon: Phone,
    label: "Phone",
    value: "+91 7976703930",
    href: "tel:+917976703930",
  },
  {
    icon: MapPin,
    label: "Location",
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-muted-foreground">
            Interested in collaborating, discussing opportunities, or just connecting? 
          ...
          <div className="space-y-6">
            ...
            <div className="glass rounded-3xl p-8 border border-primary/30">
              ...
              <p className="text-muted-foreground text-sm">
                Open to internships, full-time roles, and impactful projects in
                software engineering, full-stack development, and machine learning.
              </p>
            </div>
